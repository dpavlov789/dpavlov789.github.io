    ...
    <div class="container">
        <div class="nav-content">
            <div class="nav-links">
                ...
                <a href="#wettarten">Wettarten</a>
                <a href="#strategien">Strategien</a>
                <a href="#tipps">Expertentipps</a>
            </div>
        </div>
    </div>
</nav>
        ...
        <article>
            <section id="grundlagen">
                ...
                <div class="image-container">
                    <img src="<?php bloginfo('template_url');?>/assets/images/img1.jpg" alt="Grundlagen ">
                </div>
            ...
            <section id="strategien">
                ...
                <div class="image-container">
                    <img src="<?php bloginfo('template_url');?>/assets/images/img2.jpg" alt="Erfolgreiche Wettstrategien">
                </div>
            ...
            <section id="tipps">
                ...
                <div class="image-container">
                    <img src="<?php bloginfo('template_url');?>/assets/images/img3.jpg" alt="Expertentipps">
                </div>
